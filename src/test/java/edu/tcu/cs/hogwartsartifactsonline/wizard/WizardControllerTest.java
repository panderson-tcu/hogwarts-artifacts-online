...
public class WizardControllerTest {
    ...
    void testUpdateWizardSuccess() throws Exception {
        ...
        updatedWizard.setName("Hermione Weasley");
        ...
        this.mockMvc.perform(put(this.baseUrl + "/wizards/4").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.data.name").value("Hermione Weasley"));
    }
    ...
    void testUpdateWizardErrorWithNonExistentId() throws Exception{
        ...
        given(this.wizardService.update(eq(4), Mockito.any(Wizard.class))).willThrow(new ObjectNotFoundException("wizard", 4));
    ...
    @Test
    void testDeleteWizardErrorWithNonExistantId() throws Exception {
        // Given
    ...
    void testAssignArtifactErrorWithNonExistentArtifactId() throws Exception{
        // Given
        doThrow(new ObjectNotFoundException("artifact", "1250808601744904196")).when(this.wizardService).assignArtifact(2, "1250808601744904196");

        // When and then
        this.mockMvc.perform(put(this.baseUrl + "/wizards/2/artifacts/1250808601744904196").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
