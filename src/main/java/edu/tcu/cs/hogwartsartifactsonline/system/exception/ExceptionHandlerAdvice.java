...
public class ExceptionHandlerAdvice {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    Result handleArtifactNotFoundException(WizardNotFoundException ex){
        return new Result(false, StatusCode.NOT_FOUND, ex.getMessage());
    }
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex){
        return new Result(false, StatusCode.UNAUTHORIZED,"The access token provided is expiered, revoked, malformed, or invalid for other reasons", ex.getMessage());
    }
